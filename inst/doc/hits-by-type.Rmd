...
```{r plot1}
#| fig.alt: Time-series of percentage of hits over the years 1870-2024, by type of hit (single, double, triple, home run)
library(ggplot2)
...
type of hit.
```{r plot2}
#| fig.alt: Time-series of percentage of hits over the years 1870-2024, by type of hit (single, double, triple, home run), with linear regression lines
