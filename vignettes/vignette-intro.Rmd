...
4. [Primer for Full House Modeling](FHM-primer.Rmd) -- This vignette introduces the key ideas behind Full House Modeling, a framework connecting observed achievement to latent talent distributions. It walks through the statistical foundations and demonstrates an application comparing batting averages across eras.
...
Shen Yan, Adrian Burgos Jr., Christopher Kinson, and Daniel J. Eck (2024-2025) [Estimation of the MLB talent pool](https://eckeraadjustment.web.illinois.edu/MLBeligiblepop.html)

Steven Buechler (2014-2015) [Analysis of career performance in top home run hitters](https://web.archive.org/web/20230926102540/https://www3.nd.edu/~steve/computing_with_data/16_Baseball_example/baseball_example.html)

* This is lecture 16 from [Computing with Data Seminar](https://web.archive.org/web/20240212000848/https://www3.nd.edu/~steve/computing_with_data/)
